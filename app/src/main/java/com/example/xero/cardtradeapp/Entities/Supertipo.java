...
/**
 * Supertipo generated by hbm2java
 */
public class Supertipo implements java.io.Serializable {
    ...
    public Supertipo(String name) {
        this.name = name;
    }
    public Supertipo(String name, Set cards) {
       this.name = name;
       this.cards = cards;
    }
