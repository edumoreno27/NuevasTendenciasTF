...
public class Perfil implements java.io.Serializable {
    ...
    public Perfil(String name, String type, String status, String email, String phone, String age, String sex, int coins, BigDecimal rating, String address, int userid) {
       this.userid = userid;
       this.name = name;
       this.type = type;
       this.status = status;
