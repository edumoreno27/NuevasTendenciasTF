...
/**
 * RSubastaActualusuario generated by hbm2java
 */
public class RSubastaActualusuario implements java.io.Serializable {
    ...
    public RSubastaActualusuario() {
    }

	
    public RSubastaActualusuario(int idCurrentUser, BigDecimal amount) {
        this.idCurrentUser = idCurrentUser;
        this.amount = amount;
    }
    public RSubastaActualusuario(int idCurrentUser, BigDecimal amount, Integer idAuction) {
       this.idCurrentUser = idCurrentUser;
       this.amount = amount;
