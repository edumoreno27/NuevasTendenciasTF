...
public class Orden implements java.io.Serializable {
    ...
    public Orden(Integer id, int idAuction, boolean isReviced, String dateRecived, String status, String beginDate, String endDate, String shippingMethod, String cardName, double cost, String buyerOrSeller, int idUserSeller) {
        this.id = id;
    ...
    public Orden(int idAuction, boolean isReviced, String dateRecived, String status, String beginDate, String endDate, String shippingMethod) {
        this.idAuction = idAuction;
        this.isReviced = isReviced;
